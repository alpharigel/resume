...
%To Do:
%   - GPA is @ 2.95, which rounds to 3.00
...
\begin{tabular*}{7in}{l@{\extracolsep{\fill}}r}
	\textbf{\href{http://www.derekhildreth.com/}{\LARGE Derek Ryan Hildreth}}  & (phone removed from web version)\\
	(address removed from web version) &  \href{mailto:derek@derekhildreth.com}{derek@derekhildreth.com} \\
	Scottsdale, AZ 85259& \href{http://www.derekhildreth.com}{http://derekhildreth.com} \\
	\end{tabular*}
\\
\vspace{0.1in}}
...
\resheading{Education}
	\begin{itemize}
		\item
			...
			\ressubheading{\href{http://www.byui.edu}{Brigham Young University - Idaho}}{Rexburg, ID}{\href{http://www.byui.edu/csee/compe/default.htm}{Bachelor of Computer Engineering}; \href{http://www.derekhildreth.com/portfolio/unofficial_transcript.pdf}{GPA:3.00}}{Jan. 2004 -- Dec. 2009}
				{ \footnotesize
				\begin{itemize}
	...
	\begin{itemize}
		\item 
			\ressubheading{\href{http://www.embeddedarm.com}{Technologic Systems}}{Fountain Hills, AZ}{Embedded Systems Engineer}{Aug. 2009 -- Present}
				{ \footnotesize
				\begin{itemize}
					\resitem{Wrote and formatted detailed \href{http://www.embeddedarm.com/about/resource.php?item=409}{technical documentation} and \href{http://www.embeddedarm.com/about/resource.php?item=410}{manuals} for single board computer \href{http://www.embeddedarm.com/products/index.php}{SBC products}}
					\resitem{Provided professional, technical customer support and improved documentation to reduce support volume}
					\resitem{Created software to troubleshoot, rigorously test, and provide functionality to embedded system designs}
				\end{itemize}
				}
		\item
...
\resheading{\href{http://www.derekhildreth.com/portfolio.php}{Skills}}
	\begin{description}
		\item[Languages:] { \footnotesize C/C++, Assembly (x86), FPGA (Verilog HDL), MSDOS and Bash Shell Scripting, \href{http://www.latex-project.org/}{\LaTeX}}, HTML
...
Remote \href{http://emp.byui.edu/smithk/compe499_s09/teamwork/default.htm}{cell phone control} (\href{http://www.embeddedarm.com/products/board-detail.php?product=TS-7350}{embedded system}) for \href{http://www.inl.gov}{INL} }
